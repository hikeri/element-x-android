...
public data class MapUiSettings(
    public val compassEnabled: Boolean = false,
    public val rotationGesturesEnabled: Boolean = false,
    public val scrollGesturesEnabled: Boolean = true,
    public val tiltGesturesEnabled: Boolean = false,
    public val zoomGesturesEnabled: Boolean = true,
    public val logoGravity: Int = Gravity.TOP,
    public val attributionGravity: Int = Gravity.TOP,
